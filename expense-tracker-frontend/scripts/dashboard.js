...
async function loadInsights() {
  ...
  try {
    ...
    // Backend API call
    const data = await apiCall("/dashboard/insights");

    insightsContent.innerHTML = data.summary || "No insights available.";

  } catch (error) {
    console.error("Error loading insights:", error);
    insightsContent.innerHTML = "Failed to load insights.";
  }
}
